...
- `search`, `suggest`, and `compare` remain dependency-free retrieval and verification tools. They do not perform or claim tariff classification, and no external classifier integration is included.
